...
use LasseRafn\Fortnox\Builders\InvoicePaymentBuilder;
...
use LasseRafn\Fortnox\Requests\InvoicePaymentRequestBuilder;
...
class Fortnox
{
	...
	{
		return new InvoicePaymentRequestBuilder( new InvoicePaymentBuilder( $this->request ) );
	}
